...
def login_facebook(self, loginCnt, userFacebookPageId, insertedUserName, usersPhoneNumber, requestClient):
    ...
    returnedValue_from_method = profileTextDataCrawling(login_or_not, loginCnt, user_facebook_page_id, directlyTypedUserName, driver, usersPhoneNumber, requestClient)
...
def profileTextDataCrawling(loginValue, lgnCnt, insertedUser_fbpage_id, insertedUserName, driver, usersPhNumber, requestClient):
    ...
    #searchTVal_01[각 단계 별 배당 점수] * searchTVal_vol[배수 조정 값] = 5 * 10 // 5 * 5 // 5 * 1
    #searchTVal_edu * searchTVal_vol
    #searchCVal_live * searchCVal_vol
    #searchMVal * searchMVal_vol
    ...
    returnedResultDict = getDetailInfoDictionaryType(user_fbpage_id, driver, lgnCnt, insertedUserName, usersPhNumber, requestClient)
    print('사용자 페이스북 상의 세부 데이터 -> ', returnedResultDict)

    returnedResultDict['사용자휴대전화번호'] = usersPhNumber
    ...
    try:
        ...
        if not intro_text_title:
            ...
            profileDic['소개글'] = '소개글 영역이 존재하지 않습니다.'
    ...
    try:
        ...
        try:
            ...
            profileDic['전체프로필정보'] = '@'.join(profileDataList)


        except:
            print('더이상 가져올 수 있는 정보가 없습니다.')
            profileDic['프로필게시개수'] = 0
    ...
    for search_t in DictionaryValue_list:
        try:
            if '남성' in search_t:
                t_score_count_detail = 0
                print('성별 정보 검색 중...')
                t_score_count_detail += (searchTVal_sex * searchTVal_vol)
                print('가산 근거 : 남성일 경우 근속 기간이 여성보다 길기 때문에 ', t_score_count_detail, '점이 가산 됩니다.')
                ...
                print('성별 정보 검색 중...')
                t_score_count_detail += (searchTVal_sex * searchTVal_vol)
                print('가산 근거 : 여성일 경우 근속 기간이 남성보다 짧기 때문에 ', t_score_count_detail,'점이 가산 됩니다.')
            ...
            if '근무' in search_t:
                ...
                if '서울' in search_t:
                    t_score_count_detail += (searchTVal_work * searchTVal_vol)
                    print('가산 근거 : 근무지가 서울일 경우 ', t_score_count_detail,'점이 가산 됩니다.')
                    t_score_count += t_score_count_detail

                elif '경기' in search_t:
                    t_score_count_detail += (searchTVal_work * searchTVal_vol)
                    print('가산 근거 : 근무지가 경기일 경우 ', t_score_count_detail, '점이 가산됩니다.')

                    t_score_count += t_score_count_detail

                else:
                    t_score_count_detail += (searchTVal_work * searchTVal_vol)
                    print('가산 근거 : 근무지가 비-수도권일 경우 ', t_score_count_detail, '점이 가산됩니다.')
                ...
                if '졸업' in search_t:
                    if '대학원' in search_t:
                        ...
                        if '서울대' or '중앙대' or '덕성여' or '서울교육대' or '홍익대' or '이화여' or '서울시립대' or '동국대' or '서울여' or '연세대' or '명지대' or '숙명여' or '고려대' or '상명대' or '동덕여' or '서강대' or '삼육대' or '국민대' or '서울과학기술대' or '한국체육대' or '성신여' or '한국외' or '숭실대' or '총신대' or '세종대' or '한국종합예술' or '한성대' or '서경대' or '성공회대' in search_t:
                            ...
                            t_score_count_detail += (searchTVal_edu * searchTVal_vol)
                            print('가산 근거 : 출신 대학원 소재지가 서울일 경우 ', t_score_count_detail,'점이 가산 됩니다.')
                            ...
                            t_score_count_detail += (searchTVal_edu * searchTVal_vol)
                            print('가산 근거 : 출신 대학원 소재지가 경기일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                        ...
                        if '서울대' or '중앙대' or '덕성여' or '서울교육대' or '홍익대' or '이화여' or '서울시립대' or '동국대' or '서울여' or '연세대' or '명지대' or '숙명여' or '고려대' or '상명대' or '동덕여' or '서강대' or '삼육대' or '국민대' or '서울과학기술대' or '한국체육대' or '성신여' or '한국외' or '숭실대' or '총신대' or '세종대' or '한국종합예술' or '한성대' or '서경대' or '성공회대' in search_t:
                            ...
                            t_score_count_detail += (searchTVal_edu * searchTVal_vol)
                            print('가산 근거 : 출신 대학교 소재지가 서울일 경우 ', t_score_count_detail,'점이 가산 됩니다.')
                            ...
                            t_score_count_detail += (searchTVal_edu * searchTVal_vol)
                            print('가산 근거 : 출신 대학교 소재지가 경기일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                        ...
                        if '서울' in search_t:
                            ...
                            t_score_count_detail += (searchTVal_edu * searchTVal_vol)
                            print('가산 근거 : 출신 고등학교 소재지가 서울일 경우 ', t_score_count_detail,'점이 가산 됩니다.')
                            ...
                            t_score_count_detail += (searchTVal_edu * searchTVal_vol)
                            print('가산 근거 : 출신 고등학교 소재지가 경기일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                            ...
                            t_score_count_detail += (searchTVal_edu * searchTVal_vol)
                            print('가산 근거 : 출신 고등학교 소재지가 비-수도권일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                        ...
                        if '서울' in search_t:
                            ...
                            t_score_count_detail += (searchTVal_edu * searchTVal_vol)
                            print('가산 근거 : 출신 대학(2~3년제 대학) 소재지가 서울일 경우 ', t_score_count_detail,'점이 가산 됩니다.')
                            ...
                            t_score_count_detail += (searchTVal_edu * searchTVal_vol)
                            print('가산 근거 : 출신 대학(2~3년제 대학) 소재지가 경기일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                            ...
                            t_score_count_detail += (searchTVal_edu * searchTVal_vol)
                            print('가산 근거 : 출신 대학(2~3년제 대학) 소재지가 비-수도권일 경우 ', t_score_count_detail,'점이 가산됩니다.')
        ...
        try:
            if '거주' in search_c:
                ...
                if '서울' in search_c:
                    ...
                    c_score_count_detail += searchCVal_live * searchCVal_vol
                    print('가산 근거 : 거주지가 서울일 경우 ', t_score_count_detail,'점이 가산 됩니다.')
                    ...
                    c_score_count_detail += searchCVal_live * searchCVal_vol
                    print('가산 근거 : 거주지가 경기일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                    ...
                    c_score_count_detail += searchCVal_live * searchCVal_vol
                    print('가산 근거 : 거주지가 비-수도권일 경우 ', t_score_count_detail,'점이 가산됩니다.')
            ...
            if '출신' in search_c:
                ...
                if '서울' in search_c:
                    c_score_count_detail += searchCVal_from * searchCVal_vol
                    print('가산 근거 : 출신지가 서울일 경우 ', t_score_count_detail,'점이 가산 됩니다.')
                    ...
                    c_score_count_detail += searchCVal_from * searchCVal_vol
                    print('가산 근거 : 출신지가 경기일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                    ...
                    c_score_count_detail += searchCVal_from * searchCVal_vol
                    print('가산 근거 : 출신지가 비-수도권일 경우 ', t_score_count_detail,'점이 가산됩니다.')
            ...
            if '팔로우' in search_c:
                ...
                if followCnt >= 50:
                    ...
                    c_score_count_detail += searchCVal_fllw * searchCVal_vol
                    print('팔로워 수가 50명 이상일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                    ...
                    c_score_count_detail += searchCVal_fllw * searchCVal_vol
                    print('팔로워 수가 40명 이상 50명 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                    ...
                    c_score_count_detail += searchCVal_fllw * searchCVal_vol
                    print('팔로워 수가 30명 이상 40명 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                    ...
                    c_score_count_detail += searchCVal_fllw * searchCVal_vol
                    print('팔로워 수가 20명 이상 30명 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                    ...
                    c_score_count_detail += searchCVal_fllw * searchCVal_vol
                    print('팔로워 수가 10명 이상 20명 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                    ...
                    c_score_count_detail += searchCVal_fllw * searchCVal_vol
                    print('팔로워 수가 1명 이상 10명 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
    ...
    try:
        ...
        if userContent_FriendList:
            ...
            if friendsCnt >= 500:
                ...
                c_score_count_detail += searchCVal_frnd * searchCVal_vol
                print('친구 수가 500명 이상일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                ...
                c_score_count_detail += searchCVal_frnd * searchCVal_vol
                print('친구 수가 400명 이상 500명 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                ...
                c_score_count_detail += searchCVal_frnd * searchCVal_vol
                print('친구 수가 300명 이상 400명 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                ...
                c_score_count_detail += searchCVal_frnd * searchCVal_vol
                print('친구 수가 200명 이상 300명 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                ...
                c_score_count_detail += searchCVal_frnd * searchCVal_vol
                print('친구 수가 100명 이상 200명 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
                ...
                c_score_count_detail += searchCVal_frnd * searchCVal_vol
                print('친구 수가 1명 이상 100명 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
            ...
            c_score_count_detail += (searchCVal_frnd*5) * searchCVal_vol
            c_score_count += c_score_count_detail

            returnedResultDict.update({'친구수': '비공개로 설정되어 있음.'})

    except Exception as ex:
        print('친구 수 정보가 비공개로 되어 있어 추적에 실패했습니다.', ex)
    ...
    try:
        ...
        if likeManCnt >= 5000:
            c_score_count_detail += searchCVal_like * searchCVal_vol
            print('좋아요 표시가 5000개 이상일 경우 ', t_score_count_detail,'점이 가산됩니다.')
            ...
            c_score_count_detail += searchCVal_like * searchCVal_vol
            print('좋아요 표시가 4000개 이상 5000개 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
            ...
            c_score_count_detail += searchCVal_like * searchCVal_vol
            print('좋아요 표시가 3000개 이상 4000개 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
            ...
            c_score_count_detail += searchCVal_like * searchCVal_vol
            print('좋아요 표시가 2000개 이상 3000개 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
            ...
            c_score_count_detail += searchCVal_like * searchCVal_vol
            print('좋아요 표시가 1000개 이상 2000개 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
            ...
            c_score_count_detail += searchCVal_like * searchCVal_vol
            print('좋아요 표시가 1개 이상 1000개 미만일 경우 ', t_score_count_detail,'점이 가산됩니다.')
    ...
    returnedValue_from_method_TCMCountGen = TCMCountGen(t_score_count, c_score_count, returnedResultDict, User_timeLine_site_url_addr, driver, requestClient, searchMVal, searchMVal_vol)
...
def getDetailInfoDictionaryType(userPageId, driver, loginCnt, userName, usersPhNo, reqClientNm):
    ...
    if length_user_pglet_data == 0:
        ...
        if not user_pglet_contactData_title_01:
            ...
            if '연락처' in user_pglet_contactData_title_01[0].text:
                ...
                try:
                    ...
                    contDic['전체연락처정보'] = '@'.join(contDataList)
        ...
        if not user_pglet_contactData_title_01_2:
            ...
            contDic['웹사이트및소셜링크정보'] = '사용자가 웹사이트 및 소셜 링크 정보를 등록하지 않았습니다.'
        else:
            #pagelet_contact
            if '웹사이트' in user_pglet_contactData_title_01_2[0].text:
                ...
                try:
                    ...
                    contDic['웹사이트및소셜링크정보'] = '@'.join(contDataList_webSns)
        ...
        if not user_pglet_basicData_title_01:
            ...
            basicDic['전체기본정보'] = '사용자가 기본 정보를 등록하지 않았습니다.'
...
#TCM SCORE 산출
def TCMCountGen(tScoreCount, cScoreCount, ResultDict, user_fbpage_url, driver, requestClient, searchM_Value, searchMValue_volume):


    ResultDict['사용자이름'] = ''
    ResultDict['페이스북페이지ID'] = user_fbpage_url
    ResultDict['사용자휴대전화번호'] = ''
    ResultDict['전체기본정보'] = ''
    ResultDict['전체연락처정보'] = ''
    ResultDict['웹사이트및소셜링크정보'] = ''
    ResultDict['소개글'] = ''
    ResultDict['프로필게시개수'] = 0
    ResultDict['전체프로필정보'] = ''
    ResultDict['친구수'] = 0
    ResultDict['좋아요__사람전체명수'] = 0
    ResultDict['좋아요(image)__표시전체갯수'] = 0
    ResultDict['동영상수'] = 0
    ResultDict['사진수'] = 0
    ResultDict['fb_TSCORE'] = tScoreCount
    ResultDict['fb_CSCORE'] = cScoreCount
    ResultDict['fb_MSCORE'] = 0
    ...
    if userContent_list_result is not None:
        ...
        print('게시글(사진, 동영상 포함) 수 : ', contentCnt + (totalPicCnt*2) + prfl_vodCnt )
        print('게시글(텍스트로만 구성) 수 : ', contentCnt - (prfl_picCnt + prfl_vodCnt))
        mscore_dataCnt = contentCnt + (totalPicCnt * 2) + prfl_vodCnt
        print('Management Score 근거 자료 count :', )


        if mscore_dataCnt >= 500:

            #m_score_count_detail += 250
            m_score_count_detail += searchM_Value * searchMValue_volume
            print(m_score_count_detail, '점이 가산')
            m_score_count += m_score_count_detail
            # print("%%", m_score_count)
        elif 450 <= mscore_dataCnt < 500:

            #m_score_count_detail += 200
            m_score_count_detail += searchM_Value * searchMValue_volume
            print(m_score_count_detail, '점이 가산')
            m_score_count += m_score_count_detail
            # print("%%", m_score_count)
        elif 400 <= mscore_dataCnt < 450:

            #m_score_count_detail += 150
            m_score_count_detail += searchM_Value * searchMValue_volume
            print(m_score_count_detail, '점이 가산')
            m_score_count += m_score_count_detail
            # print("%%", m_score_count)
        elif 350 <= mscore_dataCnt < 400:

            #m_score_count_detail += 100
            m_score_count_detail += searchM_Value * searchMValue_volume
            print(m_score_count_detail, '점이 가산')
            m_score_count += m_score_count_detail
            # print("%%", m_score_count)
        elif 300 <= mscore_dataCnt < 350:
            ...
            m_score_count += m_score_count_detail
            # print("%%", m_score_count)
        elif 150 <= mscore_dataCnt < 200:

            #m_score_count_detail += 25
            m_score_count_detail += searchM_Value * searchMValue_volume
            print(m_score_count_detail, '점이 가산')
            m_score_count += m_score_count_detail
            # print("%%", m_score_count)
        elif 100 <= mscore_dataCnt < 150:
        ...
        ResultDict.update({'fb_TSCORE':tScoreCount, 'fb_CSCORE':cScoreCount, 'fb_MSCORE':mScoreCount})
        ...
        if requestClient == 'sci':
            ...
            try:
                ...
                databaseConnection.insert_record_origin_version(
                    ...
                    str(ResultDict['동영상수']),
                    str(ResultDict['사진수']),
                    str(ResultDict['fb_TSCORE']),
                    str(ResultDict['fb_CSCORE']),
                    str(ResultDict['fb_MSCORE']))
        ...
        ResultDict.update({'동영상수': 0, '사진수': 0})

        ResultDict.update({'fb_TSCORE': tScoreCount, 'fb_CSCORE': cScoreCount, 'fb_MSCORE': 0})
