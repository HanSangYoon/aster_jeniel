...
import PycharmProjects.crawling_modules_v1804.crawlerBot_package_JUST_TEST.For_test.mysqlConnection_test as mySQL_conn
import pymysql
...
def getPagination(driver, searchURL):
    ...
    dept_page_url = [page_url.format(i) for i in range(1, 10)]  #테스트를 위해 10페이지로 제한.
