...
class DatabaseConnection:
    ...
    def insert_new_record(self, f1, f2, f3, f4, f5, f6, f7, f8, f9, f10,
        ...
        try:
            insert_command = "INSERT INTO crawled_worknet_syhan(articleUniqueNum, corpNm," \
    ...
    def select_record(self):
        try:
            selectedDataList = []
            self.cursor.execute("select no_index, articleUniqueNum from crawled_worknet_syhan order by no_index ASC;")
