...
import PycharmProjects.crawling_modules_v1804.crawlerBot_package_JUST_TEST.For_test.mysqlConnection as mySQL_conn
import pymysql
...
def autoScroller(driver):
    ...
    if new_height == last_height:
        ...
        logger.debug('lastHeight: {}, newHeight: {}'.format(last_height, new_height))
        ...
        try:
            ...
            for list_length in range(len(result_autoScroller.select("#searchCondExtVO > table > tbody > tr"))):
                ...
                try:
                    ...
                    driver.get('http://www.work.go.kr/empInfo/empInfoSrch/detail/empDetailAuthView.do?callPage=detail&wantedAuthNo=KF10761806260003&rtnUrl=/empInfo/empInfoSrch/list/dtlEmpSrchList.do')

                    print('alert가 뜰꺼야')

                    returnedPossibleScroll = couldScrolling(driver)
                    print('return Test result: ', returnedPossibleScroll)
                    ...
                    if returnedPossibleScroll == True:
                        ...
                        if corpRecruitArticleTitle == corpJboArticleTitle:
                            ...
                            for infoTable_length in range(lengthOfTable):
                                print()
                                print('infoTable_No', str(infoTable_length + 1))
                                #Maria-Field :
                                ...
                                print()
                                print(infoTableTitle, ':%%:', length_table_content)
                                ...
                                if length_table_content == 1:
                                    ...
                                    result_workNetDictionaty[infoTableContent_title + '_'+ articleUniqueNum] = infoTableContent_contents
                                    print('#',infoTableContent_title, result_workNetDictionaty[infoTableContent_title + '_'+ articleUniqueNum])
                            ...
                            print('DB INSERT : ', result_workNetDictionaty['구인인증번호_' + articleUniqueNum],  # articleUniqueNum
                                  result_workNetDictionaty['회사명_' + articleUniqueNum],  # corpNm
                                  result_workNetDictionaty['공고제목_' + articleUniqueNum],  # corpWantJob
                                  result_workNetDictionaty['공고제목상세_' + articleUniqueNum],  # corpRecruitArticleTitle
