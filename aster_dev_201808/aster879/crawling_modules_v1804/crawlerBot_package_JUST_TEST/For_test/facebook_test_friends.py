...
#친구수 정보 추가
driver.get('https://www.facebook.com/kpokem/friends')
...
try:
    ...
    friends_all_cnt = friends_soup.select('#pagelet_timeline_medley_friends > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(1) > a')
    ...
    if len(friends_all_cnt) is not 0:
        ...
        for frnKindLgth in range(len(friends_all_cnt)):
            ...
            friends_data[friendsKind.replace(" ", "")] = int(friendsKind_Cnt.replace(",",""))
