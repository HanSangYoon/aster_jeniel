...
#친구수 정보 추가
driver.get('https://www.facebook.com/kpokem/likes')
...
try:
    likes_all_cnt = likes_soup.select('#pagelet_timeline_medley_likes > div:nth-of-type(1) > div:nth-of-type(2) > div:nth-of-type(1) > a')
    ...
    if len(likes_all_cnt) is not 0:
        ...
        for likesKindLgth in range(len(likes_all_cnt)):
            ...
            likes_data[likesKind.replace(" ", "")] = int(likesKind_Cnt.replace(",",""))
